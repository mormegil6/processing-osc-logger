...
3. Install the VST host of your choice
    - Set up the DAW to message via OSC the beginning of the playback to the local port according to the listening port in the Processing script (by default the port number is `12001`)

4. Install the [IEM Plug-in Suite](https://plugins.iem.at/)
